...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, io.github.jhipster.application.domain.Contest.class.getName());
            createCache(cm, io.github.jhipster.application.domain.Contest.class.getName() + ".ids");
            createCache(cm, io.github.jhipster.application.domain.Announcement.class.getName());
