...
export class AnnouncementComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.announcementService
      ...
      .subscribe(
        (res: HttpResponse<IAnnouncement[]>) => this.paginateAnnouncements(res.body, res.headers),
  ...
  trackId(index: number, item: IAnnouncement) {
    return item.id;
  }
  ...
  protected paginateAnnouncements(data: IAnnouncement[], headers: HttpHeaders) {
